...
-- {{{ Key bindings
globalkeys = gears.table.join( -- custom keybinds
awful.key({modkey}, "w", function() awful.spawn('brave') end,
          {description = "brave", group = "custom"}), -- default keybinds
awful.key({modkey}, "e", function() awful.spawn('thunar') end,
          {description = "file manager", group = "custom"}), -- default keybinds
awful.key({modkey}, "Tab",
          function() awful.spawn("rofi -show window -show-icons") end,
          {description = "rofi -show window -show-icons", group = "launcher"}),
awful.key({modkey}, "-", function() awful.spawn('flameshot gui') end,
          {description = "flameshot", group = "custom"}), -- default keybinds
awful.key({modkey}, "v", function() awful.spawn('pavucontrol') end,
          {description = "pavucontrol", group = "custom"}), -- default keybinds
awful.key({modkey}, "a", function() kbdcfg.switch() end,
          {description = "Switch keyboard layout", group = "custom"}), -- dmenu
...
awful.key({modkey}, "r",
          ...
          {description = "rofi -show drun -show-icons", group = "launcher"}),
